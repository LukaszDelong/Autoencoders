...
#Based on the paper by £. Delong, A. Kazak, The use of autoencoders for training neural networks with mixed categorical and numerical features
...
#Add noise to your categorical data
...
#Predicting the output from the AE
